# extract_itu_table.py is a script that creates a 
# comma separated file that can be used to fill a 
# sql-table with columns:
# |ituZoneNumber|dxccID|uniqueID|
...
# the script catches the source file from MYLog/dxcc/src/src_rawdata/itu_sorted.txt
